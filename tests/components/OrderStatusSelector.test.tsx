...
//Review this one, does not make complete sense
//Unit testing a reusable component
//necessary to spend time writing these tests
//we can write them once and continue retesting over and over again
