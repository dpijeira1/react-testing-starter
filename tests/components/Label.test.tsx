...
//Always use a flat structure of test suite, however in this case it is
//necessary to use nested suites for different languages
describe("Label", () => {
  ...
  it("should throw an error if given an invalid label", () => {
